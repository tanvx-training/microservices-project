...
import dev.tanvx.business_service.controller.usecase.StoreUseCase;
...
public class StoreController {
  ...
  @GetMapping
  public ResponseEntity<ApiResponse<Page<StoresResponseDTO>>> getStores(
  ...
  public ResponseEntity<ApiResponse<StoreDeleteResponseDTO>> deleteStore(
      @PathVariable(value = "storeId") Integer storeId) {
